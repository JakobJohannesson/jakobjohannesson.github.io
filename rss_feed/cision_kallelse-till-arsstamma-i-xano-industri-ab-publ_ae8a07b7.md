...
**Published:** Tue, 31 Mar 2026 12:30:00 GMT
**Source:** [https://news.cision.com/se/xano/r/kallelse-till-arsstamma-i-xano-industri-ab--publ-,c4329386](https://news.cision.com/se/xano/r/kallelse-till-arsstamma-i-xano-industri-ab--publ-,c4329386)
**GUID:** cision5335389
**Cision ID:** xano
**Keywords:** 
...
För Aktierätterna ska följande villkor gälla: 
	...
	- Aktierätter tilldelas vederlagsfritt viss tid efter utgången av Investeringsperioden.
...
Styrelsen föreslår att årsstämman, för att möjliggöra nyemission av omvandlings- och inlösenbara C-aktier, beslutar att ändra § 5 i Bolagets bolagsordning i enlighet med nedan (ändringar/tillägg är understrukna). Notera att endast stycken och meningar som föreslås ändras har inkluderats nedan. 
			...
			**§ 5 Aktier**
			...
			Beslutar bolaget att genom kontantemission eller kvittningsemission ge ut nya aktier av serie A och serie B, skall ägare av aktier av serie A och serie B, ha företrädes­rätt att teckna nya aktier av samma aktieslag i förhållande till det antal aktier som de förut äger (primär företrädesrätt). 
...
Styrelsen föreslår att årsstämman beslutar att bemyndiga styrelsen att, under tiden fram till nästa årsstämma, vid ett eller flera tillfällen, besluta om emission av C-aktier på följande villkor:
	...
	- Högst 243 100 C-aktier får emitteras.
	- De nya C-aktierna ska, med avvikelse från aktieägarnas företrädesrätt, endast få tecknas av en i förväg vidtalad bank.
	- Det belopp som ska betalas för varje ny C-aktie (teckningskursen) ska motsvara aktiens kvotvärde vid tidpunkten för teckningen.
...
Styrelsen föreslår att årsstämman beslutar att bemyndiga styrelsen att, under tiden fram till nästa årsstämma, vid ett eller flera tillfällen, besluta om återköp av C-aktier på följande villkor:
	...
	- Återköp får endast ske genom ett förvärvserbjudande som riktas till samtliga ägare av C-aktier.
	- Högst 243 100 C-aktier får återköpas.
	- Återköp ska ske till ett pris som motsvarar aktiens kvotvärde vid tidpunkten för återköpet.
	- Betalning för aktierna ska erläggas kontant.
	- Styrelsen ska äga rätt att fastställa övriga villkor för återköpet.
	- Återköp ska även kunna ske av så kallade interimsaktie avseende C-aktie, av Euroclear Sweden AB betecknad som Betald Tecknad Aktie (BTA).
...
Styrelsen föreslår att årsstämman beslutar om överlåtelse av egna B-aktier i enlighet med följande:
	...
	- Högst 197 400 B-aktier får överlåtas vederlagsfritt till Deltagarna i LTIP 2026. Aktierna ska utgöras av aktier som efter emission och återköp av C-aktier med stöd av bemyndiganden enligt (ii) och (iii) ovan har omvandlats till B‑aktier.
	- Rätt att vederlagsfritt förvärva B-aktier ska, med avvikelse från aktieägarnas företrädesrätt, tillkomma Deltagarna i LTIP 2026.
	...
	- Antalet B-aktier som får överlåtas inom ramen för LTIP 2026 kan komma att omräknas till följd av mellanliggande fondemission, uppdelning eller sammanläggning av aktier, företrädesemission och/eller andra liknande bolagshändelser. Antalet aktier som får överlåtas får dock aldrig överstiga det antal B-aktier som Bolaget innehar.
